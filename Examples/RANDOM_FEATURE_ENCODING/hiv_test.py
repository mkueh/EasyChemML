...
splitset = split_creator.generate_split(dh['hiv'], splitter_outer)

train_dataset = Dataset(dh['hiv'], name='train', feature_col=['SMILES'], target_col=['Output'],
...
job.trained_Model.save_model('HIV_STD_ECFP_4_1024_trained.model')
time_elapsed = datetime.now() - start_time
...
job_prediction = ModelEvalJob('HIV_STD_ECFP_4_1024_test', loaded_model, dh['hiv'], ['SMILES'], dh['hiv'], ['Output'], metricStack_c)
